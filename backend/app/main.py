...
from .curve_fill.router import router as curve_fill_router
from .curve_fill_render.router import router as curve_fill_render_router
from .curve_fill_capabilities.router import router as curve_fill_capabilities_router
...
app.include_router(curve_fill_router)
app.include_router(curve_fill_render_router)
app.include_router(curve_fill_capabilities_router)
